...
<br/>
            ...
            <div class="mb-4" v-if="localKnowledgeProfile.isOwner || localKnowledgeProfile.isEditor">
                    ...
                    <div class="flex space-x-4">
                        <button @click="createLink('viewerLink')"
                            ...
                            Viewer Link</button>
                        <button v-if="localKnowledgeProfile.viewerLink" @click="copyToClipboard(localKnowledgeProfile.viewerLink)"
                ...
                <div class="mb-4" v-if="localKnowledgeProfile.isOwner || localKnowledgeProfile.isEditor">
                    ...
                    <div class="flex space-x-4">
                        <button @click="createLink('editorLink')"
                            class="px-4 py-2 bg-blue-500 text-white dark:bg-blue-700">Create
                            Editor Link</button>
                        <button v-if="localKnowledgeProfile.editorLink" @click="copyToClipboard(localKnowledgeProfile.editorLink)"
                            class="px-4 py-2 bg-gray-500 text-white dark:bg-gray-700">Copy Link</button>
                    </div>
                </div>
