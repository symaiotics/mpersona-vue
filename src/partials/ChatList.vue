<template>
  <section class="relative border-t border-transparent dark:border-gray-800 mt-10">
              ...
              <button
                ...
                <svg class="w-4 h-4 shrink-0 mr-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                  <path class="fill-current"
                    :class="category === 'questions' ? 'text-teal-200 dark:text-teal-400' : 'text-teal-500'"
                ...
                <span class="transition duration-150 ease-in-out"
                  :class="category === 'questions' ? 'text-white dark:text-teal-400' : 'text-gray-600 dark:text-gray-300'">Related
                  Questions</span>
              </button>
